...
.factory('User', function($http) {
    ...
    userFactory.createProfile = function(regData) {
        return $http.post('/api/setprofile/:id', regData);
    };

     userFactory.createBankDetails = function(regData) {
        return $http.post('/api/bank/:id', regData);
    };

     userFactory.createCarDetails = function(regData) {
        return $http.post('/api/car/:id', regData);
    };

     userFactory.createDocuments = function(regData) {
        return $http.post('/api/setdocument/:id', regData);
    };

     userFactory.createDriverDetails = function(regData) {
        return $http.post('/api/driverdetails/id', regData);
    };
    ...
    userFactory.checkUsername = function(regData) {
     ...
     userFactory.checkDisplayname = function(regData) {
        return $http.post('/api/checkdisplayname', regData);
    };
    ...
    userFactory.editUser = function(id) {
     ...
     userFactory.getMain = function() {
        return $http.get('/main');
    };

    userFactory.getLogin = function() {
        return $http.get('/');
    };
